...
5. 曲面 $z=\arctan\frac{y}{x}$ 在点 $(1,1,\frac{\pi}{4})$ 处的切平面方程为 <Blank>$xx-y+2z=\frac\pi2$</Blank>.

6. 点 $(0,0)$ 是函数 $f(x,y)=(1+\mathrm e^y)\cos x-y\mathrm e^y$ 的 <Blank>极大</Blank> 值点.

7. 已知平面区域 $D$ 由曲线 $y=x^3$ 与直线 $x=1,y=-1$ 围成，则 $\iint\limits_{D}^{}[1+xy\mathrm e^{\left |x\right |+\left |y\right |}]\mathrm dx\mathrm dy=$ <Blank>$2$</Blank>.

8. 已知 $D$ 是第一象限中曲线 $y=\sqrt{1-x^2}$ 与直线 $x+y=1,y=x,y=\sqrt{3}x$ 围成的平面区域，$f(t)$ 连续，将二重积分 $\iint\limits_{D}^{}f(x^2+y^2)d\sigma$ 化为极坐标系下的累次积分为 <Blank>$\int_{\frac\pi4}^{\frac\pi3}\mathrm d\theta\int_{\frac1{\cos\theta+\sin\theta}}^1f(\rho^2)\rho\,\mathrm d\rho$</Blank>.

9. 设闭曲线 $C$ 为 $\left |x\right |+\left |y\right |=1$，则 $\oint_{C}^{}(\left |x\right |+y)\mathrm ds=$ <Blank>$2\sqrt2$</Blank>.

10. 已知 $C$ 为不经过原点的光滑曲线，从 $A(1,0)$ 到 $B(3,4)$，则 $\int\limits_{C}^{}\frac{x\mathrm dx+y\mathrm dy}{\sqrt{x^2+y^2}}$ <Blank>$4$</Blank>.
