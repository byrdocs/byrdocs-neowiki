...
1. 一平面波振幅为 $A$，其波长为 $1\,\mathrm{m}$，波矢量位于 $x-y$ 平面内，与 $x$ 轴夹 $30^\circ$ 角，该平面波的复振幅（初相位设为 $0$）为 <Blank>$A\exp{\left[\pi(\sqrt{3}x+y)\right]}$</Blank>。
...
<Figure src="23-24-1-大学物理（下）-期末-题图1.5.svg" float>
    第1.5题图
</Figure>
...
<Figure src="23-24-1-大学物理（下）-期末-题图2.svg" float>
    第二题图
</Figure>
...
<Figure src="23-24-1-大学物理（下）-期末-题图3.svg" float>
    第三题图
</Figure>
