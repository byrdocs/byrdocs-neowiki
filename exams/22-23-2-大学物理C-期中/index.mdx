...
<Solution>
    ...
    设绳的拉力 $\vec{T}$ 对 $m_1$ 所作的功为 $W_{T1}$ ，恒力 $\vec{F}$ 对 $m_2$ 所作的功为 $W_F$ ，木块A、B系统所受合外力为零时的速度为 $v$ ，弹簧在此过程中所作的功为 $W_K$。
    ...
    $$
    W_K + W_{T1} = \frac{1}{2}m_1 v^2 \tag{2}
    $$
    ...
    $$
    \begin{aligned}
    W_{T1} &= \frac{1}{2}m_1 v^2 - W_K = \frac{1}{2}m_1 \cdot \frac{F^2}{k(m_1+m_2)} + \frac{F^2}{2k}\\
